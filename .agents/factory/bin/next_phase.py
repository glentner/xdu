...
The ``xdu-build`` skill runs this at the top of every invocation instead of
...
Usage:
    uv run --with pyyaml python .agents/factory/bin/next_phase.py spec/<slug>/TECH.md
    uv run --with pyyaml python .agents/factory/bin/next_phase.py --all   # portfolio view over spec/*/TECH.md
